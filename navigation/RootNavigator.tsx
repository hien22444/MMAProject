    ...
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: true }}>
        {!currentUser ? (
          ...
          <>
            <Stack.Screen name="GuestTab" component={GuestNavigator} options={{ headerShown: false }} />
          ...
          <>
            ...
            <Stack.Screen name="BlockedUsers" component={BlockedUsersScreen} options={{ title: 'Người dùng đã bị chặn' }} />
            <Stack.Screen name="BankAccount" component={BankAccountScreen} options={{ title: 'Tài khoản / Thẻ ngân hàng' }} />
            <Stack.Screen name="ChatSettings" component={ChatSettingsScreen} options={{ title: 'Cài đặt Chat' }} />
            <Stack.Screen name="NotificationSettings" component={NotificationSettingsScreen} options={{ title: 'Cài đặt Thông báo' }} />
            <Stack.Screen name="PrivacySettings" component={PrivacySettingsScreen} options={{ title: 'Cài đặt riêng tư' }} />
            <Stack.Screen name="Language" component={LanguageScreen} options={{ title: 'Ngôn ngữ / Language' }} />
            <Stack.Screen name="CommunityStandards" component={CommunityStandardsScreen} options={{ title: 'Tiêu chuẩn cộng đồng' }} />
            <Stack.Screen name="About" component={AboutScreen} options={{ title: 'Giới thiệu' }} />
            ...
            <Stack.Screen name="SocialAccounts" component={SocialAccountsScreen} options={{ title: 'Tài khoản mạng xã hội' }} />
            <Stack.Screen name="UsernameSettings" component={UsernameSettingsScreen} options={{ title: 'Tên người dùng' }} />
            <Stack.Screen name="PhoneSettings" component={PhoneSettingsScreen} options={{ title: 'Số điện thoại' }} />
            <Stack.Screen name="EmailSettings" component={EmailSettingsScreen} options={{ title: 'Email nhận hóa đơn' }} />
          </>
        )}
      </Stack.Navigator>
    </NavigationContainer>
